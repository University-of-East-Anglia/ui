    ...
    const NavLinkItem = ({ withToggle, className, friendlyURL, nameCurrentValue }: navItem) => {
      ...
      return (
        ...
        >
          ...
          {withToggle &&
            <span className="menu-item-toggle" onClick={withToggle && toggleSubmenu}>
              <svg
                id="arrow-icon"
    ...
    return (
      <nav data-swiftype-index="false" className="oc-portal-main">
        <button onClick={menuState} className="" title="Open Menu">
          ...
          <svg className="oc-menu-icon" fill="white" viewBox="0 0 100 80" width="40" height="40">
            <rect y="00" width="100" height="15"></rect>
