...
import { ContentWithBackground, Props } from "./ContentWithBackground";

const meta: Meta = {
  title: "Accommodation/Content With Background",
  component: ContentWithBackground,
};

export default meta;

const Template: Story<Props> = (args) => <ContentWithBackground {...args} />;
